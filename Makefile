...
MOD_NAME=github.com/traas-stack/holoinsight-collector
...
unit-tests-with-cover:
	...
	@internal/buildscripts/check-test-files.sh $(subst github.com/traas-stack/holoinsight-collector/,./,$(ALL_PKGS))
